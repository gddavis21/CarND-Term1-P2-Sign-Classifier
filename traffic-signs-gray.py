...
def inference(images, num_classes, weight_decay):    
    '''
    '''
    x_image = tf.reshape(images, [-1, 32, 32, 1])
...
X_train_orig, y_train_orig = load_sign_data('../traffic-sign-data/train.p')
X_valid_orig, y_valid_orig = load_sign_data('../traffic-sign-data/valid.p')
X_test_orig, y_test_orig = load_sign_data('../traffic-sign-data/test.p')
...
X_train, y_train = preprocess_images(X_train_orig), y_train_orig
X_valid, y_valid = preprocess_images(X_valid_orig), y_valid_orig
X_test, y_test = preprocess_images(X_test_orig), y_test_orig
